...
<div class="col-md-12">
    <div class="offset-md-1 col-md-10">
        <div class="titulo-asistencia-info">Información Docente</div>
        <div class="info-alumno">
            <div class="form-group row">
                <label class="col-md-3 col-form-label" >Nombres:</label>
                <div class="col-md">
                    <input type="text" class="form-control form-control-sm"  value="${docente.nombres}" disabled="disabled" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-3 col-form-label">Apellidos:</label>
                <div class="col-md">
                    <input type="text" class="form-control form-control-sm" value="${docente.apellidos}" disabled="disabled" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-3 col-form-label">Especialidad:</label>
                <div class="col-md">
                    <input type="text" class="form-control form-control-sm" value="${docente.especialidad}" disabled="disabled" />
                </div>
            </div>
            <div class="form-group row">
                <label class="col-md-3 col-form-label">Ciclo de Enseñanza:</label>
                <div class="col-md-3">
